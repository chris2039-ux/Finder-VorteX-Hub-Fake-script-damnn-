-- VorteX Hub - Edição Completa (otimizada para mobile)
...
menuStroke.Color = Color3.fromRGB(170, 0, 255) -- Morado
...
task.spawn(function()
    while menu.Parent do
        ...
        menuStroke.Color = Color3.fromRGB(170 + 85 * t, 0 + 100 * t, 255) -- Morado dinámico
...
title.TextColor3 = Color3.fromRGB(200, 120, 255) -- Morado claro
...
statusLabel.TextColor3 = Color3.fromRGB(200, 120, 255) -- Morado claro
...
local function showStatus(msg, color)
    if statusLabel then
        ...
        statusLabel.TextColor3 = color or Color3.fromRGB(200, 120, 255) -- Morado claro
...
local function createButton(parent, size, pos, text, font, color, cornerRadius)
    ...
    btnStroke.Color = Color3.fromRGB(170, 0, 255) -- Morado
...
local btnDiscordMain = createButton(menu, UDim2.new(0.9, 0, 0, 30), UDim2.new(0.05, 0, 0, aimbotY + 30 + 12), '💬 DISCORD', Enum.Font.GothamBold, Color3.fromRGB(170, 120, 255), 12) -- Morado
...
panelStroke.Color = Color3.fromRGB(170, 0, 255) -- Morado
...
title2.Text = '⚡ MENU ⚡'
title2.TextColor3 = Color3.fromRGB(200, 120, 255) -- Morado claro
...
local desyncHighlights = {}  -- Para armazenar realces
...
local function addDesyncHighlight(model)
    ...
    highlight.FillColor = Color3.fromRGB(0, 255, 100)  -- Verde fill
    highlight.OutlineColor = Color3.fromRGB(255, 50, 50)  -- Vermelho outline
...
local function performDesyncLockdown(duration, onComplete)
    ...
    label.BackgroundTransparency = 1
    label.Text = '🌀 VorteX está dessincronizando você 🌀'
    ...
    task.delay(duration, function()
        ...
        showStatus('Desync Successful! 🌀', Color3.fromRGB(120, 255, 140))
...
local btnDesync = createButton(panel, UDim2.new(0.88, 0, 0, 42), UDim2.new(0.06, 0, 0, 32), '🌀 DESYNC BODY', Enum.Font.GothamBold, Color3.fromRGB(170, 0, 255), 14) -- Morado
...
local function updateDesyncButton()
    ...
    elseif antiHitActive then
        ...
        btnDesync.BackgroundColor3 = Color3.fromRGB(170, 0, 255) -- Morado
...
btnDesync.MouseButton1Click:Connect(function()
    ...
    if antiHitActive then
        ...
        executeAntiHit()
        updateDesyncButton()
        showStatus('DESYNC BODY ON 🌀', Color3.fromRGB(120, 255, 120))
    end
end)
...
-- Botão STEAL FLOOR
local btnStealFloor = createButton(panel, UDim2.new(0.88, 0, 0, 34), UDim2.new(0.06, 0, 0, flyY + 34 + 12), '🏗️ STEAL FLOOR', Enum.Font.GothamBold, Color3.fromRGB(170, 0, 255), 14) -- Morado
btnStealFloor.MouseButton1Click:Connect(function()
    if not sfActive then
        ...
        sfDisable()
        btnStealFloor.BackgroundColor3 = Color3.fromRGB(170, 0, 255) -- Morado
...
-- Glow animado melhorado para botão
task.spawn(function()
    while openBtn.Parent do
        task.wait(GLOW_UPDATE_INTERVAL)
        local t = math.sin(tick() * 3)
        glowBtn.Color = Color3.fromRGB(170 + 85 * t, 0 + 100 * t, 255) -- Morado dinámico
...
-- Novo: Design bonito com gradientes, animações, emojis; Realce Desync (verde+vermelho para original/clone)
