...
-- [NEXUS MOD] Cambiados los nombres de archivo
local SETTINGS_FILE = "NexusFinderSettings.json"
local GUI_STATE_FILE = "NexusFinderGUIState.json"
local API_STATE_FILE = "NexusFinderAPIState.json"
...
-- [NEXUS MOD] Tema morado
local THEME = {
    Background = Color3.fromRGB(15, 10, 25),
    Header = Color3.fromRGB(25, 15, 40),
    Accent = Color3.fromRGB(160, 50, 255),
    Text = Color3.fromRGB(240, 230, 255),
    Button = Color3.fromRGB(40, 25, 60),
    ButtonHover = Color3.fromRGB(60, 40, 90),
    Input = Color3.fromRGB(20, 15, 30),
...
local function createSettingsGUI()
    ...
    screenGui.Name = "NexusFinderGUI" -- [NEXUS MOD] Nombre cambiado
    ...
    mainFrame.BackgroundColor3 = THEME.Background -- [NEXUS MOD] Color morado
    ...
    mainStroke.Color = THEME.Accent -- [NEXUS MOD] Borde morado
    mainStroke.Parent = mainFrame
    
    local titleBar = Instance.new("Frame")
    titleBar.Size = UDim2.new(1, 0, 0, 30)
    titleBar.Position = UDim2.new(0, 0, 0, 0)
    titleBar.BackgroundColor3 = THEME.Header -- [NEXUS MOD] Color morado
    ...
    titleFix.BackgroundColor3 = THEME.Header -- [NEXUS MOD] Color morado
    ...
    titleLabel.Text = "NEXUS FINDER" -- [NEXUS MOD] Nombre cambiado
    titleLabel.TextColor3 = THEME.Accent -- [NEXUS MOD] Texto morado
    ...
    scrollFrame.ScrollBarImageColor3 = THEME.Accent -- [NEXUS MOD] Scroll morado
    ...
    local function createInputField(name, placeholder, defaultValue, layoutOrder, settingKey, desc)
        ...
        label.Text = name
        label.TextColor3 = THEME.Text -- [NEXUS MOD] Texto morado claro
        label.TextSize = 9
        ...
        inputFrame.BackgroundColor3 = THEME.Input -- [NEXUS MOD] Color morado oscuro
        ...
        inputStroke.Color = THEME.Accent -- [NEXUS MOD] Borde morado
        ...
        textBox.PlaceholderText = placeholder
        textBox.TextColor3 = THEME.Text -- [NEXUS MOD] Texto morado claro
        textBox.PlaceholderColor3 = Color3.fromRGB(120, 120, 130)
        textBox.TextSize = 10
        textBox.Font = Enum.Font.Gotham
    ...
    local function createSortOrderToggle(name, defaultValue, layoutOrder, desc)
        ...
        toggleButton.BackgroundColor3 = THEME.Input -- [NEXUS MOD] Color morado oscuro
        toggleButton.BorderSizePixel = 0
        toggleButton.Text = defaultValue
        toggleButton.TextColor3 = THEME.Text -- [NEXUS MOD] Texto morado claro
        ...
        toggleStroke.Color = THEME.Accent -- [NEXUS MOD] Borde morado
    ...
    _G.CloseHop = function()
        pcall(function()
            ...
            if playerGui then
                local hopperGui = playerGui:FindFirstChild("NexusFinderGUI") -- [NEXUS MOD] Nombre cambiado
                if hopperGui then
                    hopperGui:Destroy()
                end
            end
